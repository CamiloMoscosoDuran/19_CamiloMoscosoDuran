...
public class ContactView extends JFrame {
    ...
    private void initUI() {
        ...
        tableModel = new DefaultTableModel(new String[]{"ID", "Nombre", "Email", "DNI", "Teléfono"}, 0) {
        ...
        styleButton(addBtn, new Color(105, 239, 26)); // azul vibrante
        ...
        Color fondo = new Color(133, 173, 191); // Ejemplo: un azul muy claro
        contentPanel.setBackground(fondo);
        buttonsPanel.setBackground(fondo);
    ...
    private void loadContacts() {
        ...
        for (Contact c : contacts) {
            tableModel.addRow(new Object[]{c.id(), c.name(), c.email(), c.DNI(), c.phone()});
        }
    }
